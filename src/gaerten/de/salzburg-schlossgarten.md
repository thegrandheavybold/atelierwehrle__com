...
mainArticle:
  ...
  copy: "Das Parterre am Schloss Leopoldskron in Salzburg, dem ehemaligen Zuhause
    ...
    Schauplatz einer Chanel-Fashion-Show unter Karl Lagerfeld diente,
    inspirierte mich zur Neugestaltung des Gartens.


    \      Bei der Gestaltung wurde die barocke Architektur des Schlosses
    aufgegriffen und zeitgemäß neu interpretiert. Statt des monotonen
    Kiesparterre erblühen nun Rosen und Stauden in lebendigen Farben. Der kranke
    Buchsbaum wurde durch eine besondere Eibe ersetzt, die dem Garten frische
    Struktur verleiht. Brunnen und Bänke nach Entwürfen von Manuel Wehrle fügen
    sich harmonisch in das Gesamtkonzept ein.


    \      Dieser Schlossgarten zeigt, wie Tradition und Moderne auf
    stilvolle Weise verbunden werden können. Lassen Sie sich von dieser
    Gestaltung inspirieren und entdecken Sie, wie ein individuell gestalteter
